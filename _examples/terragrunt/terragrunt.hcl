##------------------------------------------------------------
## Terragrunt configuration for DigitalOcean Certificate
##
## Prerequisites:
...
##   - All domains in domain_names must be delegated to DigitalOcean DNS
##
## Deploy:
##   terragrunt init
##   terragrunt plan
...
##------------------------------------------------------------
terraform {
  source = "git::https://github.com/terraform-do-modules/terraform-digitalocean-certificate.git//?ref=v1.0.0"
...
##------------------------------------------------------------
## Module inputs
## Provisions a Let's Encrypt certificate for the listed domains.
## All domains must be managed by DigitalOcean DNS before apply.
##
## To provision a custom certificate instead, set:
##   custom_certificate = true
##   type               = "custom"
##   private_key        = "/path/to/private_key.pem"
##   leaf_certificate   = "/path/to/cert.pem"
##   certificate_chain  = "/path/to/fullchain.pem"
##------------------------------------------------------------
inputs = {
  enabled            = true
  custom_certificate = false
  certificate_name   = "${local.project}-${local.environment}-cert"
